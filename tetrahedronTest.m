classdef tetrahedronTest < matlab.unittest.TestCase
    ...
    properties (TestParameter)
        ...
        S_tetrahedrons = struct(...
            'unitTetrahedron', eye(3),...
            'unitTetrahedronDisplaced', [1 -2 0; 0 -1 0; 0 0 1],...
            'unitTetrahedronMirrored', [0 -1 -1; -1 0 -1; -1 -1 0]);
    end
    ...
    methods (Test, ParameterCombination='sequential')
        ...
        function testMappingToGlobal(testCase, tetrahedrons, vertices, S_tetrahedrons)
            actSolution = map2global(tetrahedrons, vertices);
            testCase.verifyEqual(actSolution, S_tetrahedrons, ... 
