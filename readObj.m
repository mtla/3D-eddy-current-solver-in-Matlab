...
% and modified to fulfil project needs by Henrik Hillner
%
% Modifications make the script ignore faces because we only need vertices
%
% source: https://se.mathworks.com/matlabcentral/fileexchange/27982-wavefront-obj-toolbox/content/read_wobj.m
